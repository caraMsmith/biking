...
library(readr)
raw_abp_y4 <- read.delim("abp_y4.txt", header=TRUE, sep="\t")
View(raw_abp_y4)
...
raw_abp_y4$date_abp <- as.Date(raw_abp_y4$datetime)
raw_abp_y4$date_start <- as.Date(raw_abp_y4$datetime)
raw_abp_y4$date_wake <- as.Date(raw_abp_y4$datetime)


abp_check_y4_start <- right_join(raw_abp_y4, checklist, by = c("subjectid", "date_start"), all.x = TRUE)
abp_check_y4_wake <- right_join(raw_abp_y4, checklist, by = c("subjectid", "date_wake"), all.x = TRUE)

abp_check_y4_start_2 <- merge(raw_abp_y4, checklist, by = c("subjectid", "date_start"), all.x = TRUE)
abp_check_y4_wake_2 <- merge(raw_abp_y4, checklist, by = c("subjectid", "date_wake"), all.x = TRUE)


abp_check_y4_start <- filter(abp_check_y4_start, !is.na(systolic_bp))
abp_check_y4_wake <- filter(abp_check_y4_wake, !is.na(systolic_bp))

abp_check_y4_start_2 <- filter(abp_check_y4_start_2, !is.na(date_bike))
abp_check_y4_wake_2 <- filter(abp_check_y4_wake_2, !is.na(date_bike))


abp_check_y4 <- bind_rows(abp_check_y4_start, abp_check_y4_wake)

abp_check_y4_2 <- bind_rows(abp_check_y4_start_2, abp_check_y4_wake_2)

#  abp_check_y4 and abp_check_y4_2  are same data table 


#adding sleep wake 
abp_check_y4$timeA <- as.POSIXct(abp_check_y4$datetime,format = "%Y-%m-%d %H:%M", tz = "America/New_York" )

abp_check_y4$sleep_wake <- ifelse(abp_check_y4$timeA >= abp_check_y4$sleep  & 
                                    abp_check_y4$timeA <= abp_check_y4$wakeup, "sleep", "wake") 

abp_check_y4$stage [abp_check_y4$sleep_wake == "sleep"] <- "sleep"

#add baseline; created numeric times for each because that is the only way I could get it to work

abp_check_y4$morn_bike_start_nu <- as.numeric(abp_check_y4$morn_bike_start)
abp_check_y4$wakeup_nu <- as.numeric(abp_check_y4$wakeup)
abp_check_y4$timeA_nu <- as.numeric(abp_check_y4$timeA)

# subtracted an hour from start of bike ride to get begining of baseline
abp_check_y4$baseT <- abp_check_y4$morn_bike_start_nu - 3600

abp_check_y4$stage [abp_check_y4$timeA_nu < abp_check_y4$morn_bike_start_nu & 
                      abp_check_y4$timeA_nu >= abp_check_y4$baseT] <- "Baseline"


#add immed after morning ride ( one hour period); add hour to end of bike time to get end of immed period

abp_check_y4$morn_bike_end_nu <- as.numeric(abp_check_y4$morn_bike_end)
abp_check_y4$immedT <- abp_check_y4$morn_bike_end_nu + 3600

abp_check_y4$stage [abp_check_y4$timeA_nu > abp_check_y4$morn_bike_end_nu & 
                      abp_check_y4$timeA_nu <= abp_check_y4$immedT] <- "immed"

#post1 hour after morning ride
abp_check_y4$post1T <- abp_check_y4$immedT + 3600
abp_check_y4$stage [abp_check_y4$timeA_nu > abp_check_y4$immedT & 
                      abp_check_y4$timeA_nu <= abp_check_y4$post1T] <- "post1"

#post 2 hours after morning ride
abp_check_y4$post2T <- abp_check_y4$post1T + 3600
abp_check_y4$stage [abp_check_y4$timeA_nu > abp_check_y4$post1T & 
                      abp_check_y4$timeA_nu <= abp_check_y4$post2T] <- "post2"

#post 3 hours after morning ride
abp_check_y4$post3T <- abp_check_y4$post2T + 3600
abp_check_y4$stage [abp_check_y4$timeA_nu > abp_check_y4$post2T & 
                      abp_check_y4$timeA_nu <= abp_check_y4$post3T] <- "post3"

#post 4 hours after morning ride 
abp_check_y4$post4T <- abp_check_y4$post3T + 3600
abp_check_y4$stage [abp_check_y4$timeA_nu > abp_check_y4$post3T &
                      abp_check_y4$timeA_nu <= abp_check_y4$post4T] <- "post4"



# baseline period before evening ride

abp_check_y4$eve_bike_start_nu <- as.numeric(abp_check_y4$eve_bike_start)
abp_check_y4$eve_bike_end_nu <- as.numeric(abp_check_y4$eve_bike_end)

abp_check_y4$baseT_eve <- abp_check_y4$eve_bike_start_nu - 3600

abp_check_y4$stage [abp_check_y4$timeA_nu < abp_check_y4$eve_bike_start_nu & 
                      abp_check_y4$timeA_nu >= abp_check_y4$baseT_eve] <- "Eve_Baseline"

#immed after evening ride 
abp_check_y4$immedT_eve <- abp_check_y4$eve_bike_end_nu + 3600
abp_check_y4$stage [abp_check_y4$timeA_nu > abp_check_y4$eve_bike_end_nu 
                    & abp_check_y4$timeA_nu < abp_check_y4$immedT_eve] <- "Eve_immed"

# post 1 hour after evening ride
abp_check_y4$post1T_eve <- abp_check_y4$immedT_eve + 3600
abp_check_y4$stage [abp_check_y4$timeA_nu > abp_check_y4$immedT_eve & abp_check_y4$timeA_nu <= abp_check_y4$post1T_eve] <- "Eve_post1"

#post 2 hours after evening ride
abp_check_y4$post2T_eve <- abp_check_y4$post1T_eve + 3600
abp_check_y4$stage [abp_check_y4$timeA_nu > abp_check_y4$post1T_eve & abp_check_y4$timeA_nu <= abp_check_y4$post2T_eve] <- "Eve_post2"

#post 3 hours after evening ride
abp_check_y4$post3T_eve <- abp_check_y4$post2T_eve + 3600
abp_check_y4$stage [abp_check_y4$timeA_nu > abp_check_y4$post2T_eve & abp_check_y4$timeA_nu <= abp_check_y4$post3T_eve] <- "Eve_post3"

#post 4 hours after evening ride
abp_check_y4$post4T_eve <- abp_check_y4$post3T_eve + 3600
abp_check_y4$stage [abp_check_y4$timeA_nu > abp_check_y4$post3T_eve & abp_check_y4$timeA_nu <= abp_check_y4$post4T_eve] <- "Eve_post4"
...
summary(abp_check_y4$stage=="sleep")

# 807 total sleep readings

#number of non-error sleep readings

summary(abp_check_y4$stage=="sleep" & is.na(abp_check_y4$event_code))

# 638 night readings (non-error) 

#get rid of 'sessionid' as it has incorrect session id. use 'session_id' instead

abp_check_y4$sessionid <- NULL

# subset of data with only non-error readings 

abp_check_y4_read <- filter(abp_check_y4, abp_check_y4$event_code!= "EE" | is.na(abp_check_y4$event_code))
# succussfull readings  : 5009

# add binary columns for sleep and wake to easily get sums 

abp_check_y4_read$sleep_read <- ifelse(abp_check_y4_read$sleep_wake=="sleep",1,0)
abp_check_y4_read$wake_read <- ifelse(abp_check_y4_read$sleep_wake=="wake",1,0)

abp_check_y4_read$stage [is.na(abp_check_y4_read$stage)] <- "wake"

#add binary for baseline, immed, post1, ect... 
abp_check_y4_read$base_read <- ifelse(abp_check_y4_read$stage=="Baseline",1,0)
abp_check_y4_read$immed_read <- ifelse(abp_check_y4_read$stage=="immed",1,0)
abp_check_y4_read$post1_read <- ifelse(abp_check_y4_read$stage=="post1",1,0)
abp_check_y4_read$post2_read <- ifelse(abp_check_y4_read$stage=="post2",1,0)
abp_check_y4_read$post3_read <- ifelse(abp_check_y4_read$stage=="post3",1,0)
abp_check_y4_read$post4_read <- ifelse(abp_check_y4_read$stage=="post4",1,0)
abp_check_y4_read$eve_base_read <- ifelse(abp_check_y4_read$stage=="Eve_Baseline",1,0)
abp_check_y4_read$eve_immed_read <- ifelse(abp_check_y4_read$stage=="Eve_immed",1,0)
abp_check_y4_read$eve_post1_read <- ifelse(abp_check_y4_read$stage=="Eve_post1",1,0)
abp_check_y4_read$eve_post2_read <- ifelse(abp_check_y4_read$stage=="Eve_post2",1,0)
abp_check_y4_read$eve_post3_read <- ifelse(abp_check_y4_read$stage=="Eve_post3",1,0)
abp_check_y4_read$eve_post4_read <- ifelse(abp_check_y4_read$stage=="Eve_post4",1,0)
...
ABP_summary_y4 <- abp_check_y4_read %>% group_by(subjectid, session_id) %>% dplyr::summarise(subjectid[1], session_id[1], datetime[1], length(systolic_bp), min(systolic_bp), mean(systolic_bp), max(systolic_bp), sd(systolic_bp), min(diastolic_bp), mean(diastolic_bp), max(diastolic_bp), sd(diastolic_bp), mean(mean_arterial_p), mean(heart_rate), sum(sleep_read), sum(wake_read), sum(base_read), sum(immed_read), sum(post1_read),
...
names(ABP_summary_y4)[names(ABP_summary_y4)=="sum(sleep_read)"] <- "sleep_read"

mean(ABP_summary_y4$sleep_read, na.rm = TRUE)
...
abp_check_y4_read<- filter(abp_check_y4_read, systolic_bp < 260)
abp_check_y4_read<- filter(abp_check_y4_read, systolic_bp > 70)
abp_check_y4_read<- filter(abp_check_y4_read, diastolic_bp < 150)
abp_check_y4_read<- filter(abp_check_y4_read, diastolic_bp > 40)

# table of means
abp_stages_mean <- abp_check_y4_read %>% group_by(subjectid, session_id, stage) %>% dplyr::summarise(length(systolic_bp), min(systolic_bp), mean(systolic_bp), max(systolic_bp), sd(systolic_bp), min(diastolic_bp), mean(diastolic_bp), max(diastolic_bp), sd(diastolic_bp), mean(mean_arterial_p))
...
#all waketime data
wakesleep_mean <- abp_check_y4_read %>% group_by(subjectid, session_id, sleep_wake) %>% dplyr::summarise(length(systolic_bp), min(systolic_bp), mean(systolic_bp), max(systolic_bp), sd(systolic_bp), min(diastolic_bp), mean(diastolic_bp), max(diastolic_bp), sd(diastolic_bp), mean(mean_arterial_p))
...
abp_wide_y4 <- full_join(base_means, immed_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, post1_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, post2_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, post3_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, post4_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, Ebase_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, Eimmed_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, Epost1_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, Epost2_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, Epost3_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, Epost4_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, sleep_means, by= c("subjectid", "session_id"))
abp_wide_y4 <- full_join(abp_wide_y4, wake_means, by= c("subjectid", "session_id"))
...
abp_base_y4_read <- filter(abp_check_y4_read, base_read == 1 | eve_base_read == 1)
ABP_summary_y4_base <- abp_base_y4_read %>% group_by(subjectid, session_id) %>% dplyr::summarise(subjectid[1], session_id[1], datetime[1], length(systolic_bp), 
...
library(dplyr)
library(ggplot2)
abp_check_y4_read$time_short <- format(as.POSIXct(strptime(abp_check_y4_read$datetime, "%Y-%m-%d %H:%M", tz= "America/New_York")), format = "%H:%M")
#keeps staged in order
abp_check_y4_read$stage <- factor(abp_check_y4_read$stage, levels = c("Baseline", "immed", "post1","post2","post3","post4","Eve_Baseline", "Eve_immed", "Eve_post1","Eve_post2","Eve_post3","Eve_post4", "sleep"))

b2076 <- filter(abp_check_y4_read, subjectid == "BIKE2076")
...
#sleeptime data
abp_wide_y4$changescore_sys <- (abp_wide_y4$sys_sleep_mean * abp_wide_y4$sys_wake_mean)/abp_wide_y4$sys_wake_mean
abp_wide_y4$dnratio_sys <- abp_wide_y4$sys_sleep_mean / abp_wide_y4$sys_wake_mean
#Nocturnal decline
abp_wide_y4$nocdecline <- ((abp_wide_y4$sys_wake_mean - abp_wide_y4$sys_sleep_mean)/abp_wide_y4$sys_wake_mean) * 100
#Dippers ; Non dippers if noturnal decline <= 10%
abp_wide_y4$dippers [abp_wide_y4$nocdecline <= 10] <- "Non-dipper"
abp_wide_y4$dippers [abp_wide_y4$nocdecline > 10] <- "Dipper"

abp_wide_y4_sleep <- select(abp_wide_y4, subjectid, session_id, changescore_sys, dnratio_sys, nocdecline, dippers)

write.csv(abp_wide_y4, "abp_wide_y4.csv")
