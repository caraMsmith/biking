...
bike1020_sec <- read.csv("bike1020_sec.csv")


bike1020_sec$PM_cat <- factor(bike1020_sec$PM_cat, levels = c("<10", "10-25", "25-50", ">50"))
bike1020_sec$MV_cat <- factor(bike1020_sec$MV_cat , levels = c("3-35", "35-50", "50-70", "70-170"))  
bike1020_sec$PMdose_cat <-factor(bike1020_sec$PMdose_cat, levels = c("<200", "200-350", "350-500", ">500"))
bike1020_sec$BC_cat <- factor(bike1020_sec$BC_cat, levels = c("<1", "1-2", "2-4", ">4"))
bike1020_sec$BCdose_cat <-factor(bike1020_sec$BCdose_cat, levels = c("0-40", "40-100", "100-200", ">200"))

bike1020_sec$tod <- factor(bike1020_sec$tod, levels = c("Morning", "Evening"))

bike1020_sec_s1 <- subset(bike1020_sec, session== "1")


# pm
#session 1
qmap("Columbia University, NYC", zoom = 13, color= "color", legend = "right") + 
  geom_point(data = bike1020_sec_s1, aes(longitude, latitude, color=PM_cat), size =2)  +facet_wrap(tod ~ day) +
...
#session 1
qmap("Columbia University, NYC", zoom = 13, color= "color", legend = "right") + 
  geom_point(data = bike1020_sec_s1, aes(longitude, latitude, color=MV_cat), size = 2) + ggtitle("Evening Ride") +
...
#session 1
qmap("Columbia University, NYC", zoom = 13, color= "color", legend = "right") + 
  geom_point(data = bike1020_sec_s1, aes(longitude, latitude, color=PMdose_cat), size =2) + ggtitle("Evening Ride") +
...
#session 1
qmap("Columbia University, NYC", zoom = 13, color= "color", legend = "right") + 
  geom_point(data = bike1020_sec_s1, aes(longitude, latitude, color=BC_cat), size =2) + facet_wrap(tod~day) +
...
#session 3
qmap("Columbia University, NYC", zoom = 13, color= "color", legend = "right") + 
  geom_point(data = bike1020_sec_s1, aes(longitude, latitude, color=BCdose_cat), size = 2) +
...
bike1020_sec_s1$TimeA <- as.POSIXct(bike1020_sec_s1$datetime1.y)
bike1020_sec_s1 <- filter(bike1020_sec_s1, bc.clean2 <100)
...
#BC session 1
ggplot(bike1020_sec_s1, aes(x= TimeA , y= bc.clean2, col = biking)) + geom_line() + xlab("Time of Day") + ylab("Black Carbon (ug/m^3)") + ggtitle("Black Carbon: Session 1") +theme(legend.position = "none", axis.text.x=element_text(size=18), axis.text.y= element_text(size=18), axis.title.x= element_text(size=18), axis.title.y= element_text(size=18), title= element_text(size=18))
# MV session 1
ggplot(bike1020_sec_s1, aes(x= TimeA, y= adj.mv, col = biking)) + geom_line() + xlab("Time of Day") + ylab("Minute Ventilation (l/min)") + ggtitle("Minute Ventilation: Session 1") +theme(legend.position = "none", axis.text.x=element_text(size=18), axis.text.y= element_text(size=18), axis.title.x= element_text(size=18), axis.title.y= element_text(size=18), title= element_text(size=18))
# BC dose session 1 
ggplot(bike1020_sec_s1, aes(x= TimeA , y= bcdose, col = biking)) + geom_line() + xlab("Time of Day") + ylab("Black Carbon Dose (ng/min)") + ggtitle("Black Carbon Dose: Session 1") +theme(legend.position = "none", axis.text.x=element_text(size=18), axis.text.y= element_text(size=18), axis.title.x= element_text(size=18), axis.title.y= element_text(size=18), title= element_text(size=18))

#PM session 1
ggplot(bike1020_sec_s1, aes(x= TimeA , y= pm.clean2, col = biking)) + geom_line() + xlab("Time of Day") + ylab("PM2.5 (ug/m^3)") + ggtitle("PM2.5: Session 1") +theme(legend.position = "none", axis.text.x=element_text(size=18), axis.text.y= element_text(size=18), axis.title.x= element_text(size=18), axis.title.y= element_text(size=18), title= element_text(size=18))

# PM dose session 1 
ggplot(bike1020_sec_s1, aes(x= TimeA , y= pmdose, col = biking)) + geom_line() + xlab("Time of Day") + ylab("PM2.5 Dose (ng/min)") + ggtitle("PM2.5 Dose: Session 1") +theme(legend.position = "none", axis.text.x=element_text(size=18), axis.text.y= element_text(size=18), axis.title.x= element_text(size=18), axis.title.y= element_text(size=18), title= element_text(size=18))
